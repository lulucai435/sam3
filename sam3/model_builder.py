...
def _setup_device_and_mode(model, device, eval_mode):
    ...
    # Accept "cuda", "cuda:0", "cuda:1", torch.device(...), etc.
    # Previously only exact "cuda" moved weights to GPU, which breaks multi-GPU
    # when callers pass "cuda:<id>" (inputs on GPU but weights stay on CPU).
